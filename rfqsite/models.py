...
class SP_Rate(models.Model):
    ...
    mpi = models.FloatField(null=True)
    passivation = models.FloatField(null=True)
    caa = models.FloatField(null=True)
    saa = models.FloatField(null=True)
    hard_anodizing = models.FloatField(null=True)
    ccc = models.FloatField(null=True)
    dfl = models.FloatField(null=True)
    paint = models.FloatField(null=True)
    cadmium_plating = models.FloatField(null=True)
    chrome_plating = models.FloatField(null=True)
    heat_treatment = models.FloatField(null=True)
...
class Active_Rate(models.Model):
    ...
    hcm = models.FloatField(null=True)
