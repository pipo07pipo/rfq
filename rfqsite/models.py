...
class Material(models.Model):
    ...
    cross_section = models.CharField(max_length=200, null=True)
    ...
    rm_d1_unit = models.CharField(max_length=10, null=True)
    rm_d2 = models.FloatField(null=True)
    rm_d2_unit = models.CharField(max_length=10, null=True)
    rm_t = models.FloatField(null=True)
    rm_t_unit = models.CharField(max_length=10, null=True)
    rm_w = models.FloatField(null=True)
    rm_w_unit = models.CharField(max_length=10, null=True)
    rm_l = models.FloatField(null=True)
    rm_l_unit = models.CharField(max_length=10, null=True)
